...
namespace BeMyShotgunSir.Scripts.Core.Lobby
{
    ...
    public interface ILobbyManager_NetController : IManager_NetController
    {
        ...
        void SetTeamInfos_Response(SyncDictionaryOperation op, int key, LobbyTeamInfo value);
    }
    ...
    public class LobbyManager : NetworkBehaviour, ILobbyManager, ILobbyBindSources, IEventSender
    {
        ...
        public void SetTeamInfos_Response(SyncDictionaryOperation op, int key, LobbyTeamInfo value) => _viewModel.SetTeamInfos(op, key, value);
    }
}
